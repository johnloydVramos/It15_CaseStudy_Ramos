...
if(isset($_POST['Submit'])) {   
    ...
    if(empty($fname) || empty($lname) || empty($bday) || empty($email) || empty($addres)){              
        if(empty($fname)) {
        ...
        $query = "INSERT INTO users_tbl (first_name,last_name,date_of_birth,email,addre,pass,regs_date) VALUES('$fname','$lname','$bday','$email','$addres','$pass','$regs_date')";
